...
module.exports = async function (context, req) {
  try {
    const e = (req.query && req.query.e || '').toLowerCase(); if(!e){ context.res = { status:400, body:'Missing email' }; return; }
    ...
    ent.status='unsubscribed'; ent.unsubscribedAt=new Date().toISOString(); await table.updateEntity(ent,'Replace');
